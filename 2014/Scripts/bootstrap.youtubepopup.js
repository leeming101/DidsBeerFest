...
(function ($) {
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            if ($YouTubeModal == null) {
                ...
                var modalContent = '<div class="modal-dialog" id="YouTubeModalDialog" style="width:640px">'+
    ...
    function getYouTubeUrl(youtubeId, options) {
        var YouTubeURL = "//www.youtube.com/embed/" + youtubeId + "?rel=0?vq=hd720&showsearch=0&autohide=" + options.autohide;
